const AsideRight = () => {
  return (
    <div>
      <aside className="col-md-4 col-xs-12 col-xl-4  justify-content-end container-aside order-3">
        <div className="card">
          <span className="-border2 border border-dark bg-black rounded-top"></span>
          <div className="bg-light card-body pt-0">
            <div className="d-flex image-document">
              <img
                className="targetusr me-2 mb-2"
            ...
            <div className="d-grid gap-2">
              <button className="follow2 btn btn-primary mb-3" type="button">
                Follow
              </button>
            </div>
